function initMap() {
  ...
  var calculateAndDisplayRoute = function(directionsService, directionsDisplay){
    directionsService.route({
      ...
      if (status==='OK'){
        var distancia = Number((responsive.routes[0].legs[0].distance.text.replace("km","")).replace("","."));
  ...
  var ruta = document.getElementById("trazar-ruta");
  ruta.addEventListener("click", trazarRuta);
}